...
class DINetTrainingOptions():
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--lamb_syncnet_perception', type=float, default=0.1, help='weight of perception loss')
        ...
        self.parser.add_argument('--non_decay', default=80, type=int, help='num of epoches with fixed learning rate')
        self.parser.add_argument('--decay', default=80, type=int, help='num of linearly decay epochs')
        self.parser.add_argument('--checkpoint', type=int, default=2000, help='num of checkpoints in training stage')
